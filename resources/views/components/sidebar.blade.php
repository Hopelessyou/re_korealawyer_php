      ...
      <div class="mini-item">
        ...
        <div class="lawyer-profile">
          ...
          <div class="lawyer-info">
            <div class="lawyer-name">OOO 변호사</div>
            <div class="lawyer-desc">변호사 소개입니다. 변호사 소개입니다. 변호사 소개입니다. 변호사 소개...</div>
          </div>
        </div>
      </div>
      <div class="mini-item">
  ...
  <div class="widget widget-similarcases"><div class="wtitle">유사 해결사례</div>
    <div class="mini-list">
      <div class="case-item">
        ...
        <div class="case-info">
          <div class="case-title">해결사례 제목입니다. 해결사례 제목</div>
          <div class="case-lawyer">OOO 변호사</div>
        </div>
      </div>
      <div class="case-item">
        <div class="case-avatar"></div>
        <div class="case-info">
          <div class="case-title">해결사례 제목입니다. 해결사례 제목</div>
          <div class="case-lawyer">김전수 변호사</div>
        </div>
      </div>
      <div class="case-item">
        <div class="case-avatar"></div>
